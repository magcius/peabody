...
/**
 * web_socket_server_get_resource:
 *
 * Gets the resource that the client asked for. If the client connects
 * to "ws://foo.bar:8080/what/a/cool/resource", then this will return
 * "/what/a/cool/resource".
 *
 * This can be used to route WebSocket connections.
 */
const char *
web_socket_server_get_resource (WebSocketServer *self)
{
